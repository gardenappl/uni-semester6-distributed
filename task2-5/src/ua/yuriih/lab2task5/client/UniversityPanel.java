...
import ua.yuriih.lab2task5.client.operations.*;
...
public class UniversityPanel extends JPanel {
    ...
    public UniversityPanel(Channel channel) {
        ...
        deleteButton.addActionListener(actionEvent -> {
            ...
            try {
                ...
                op.performQuery(selected.group.getId());
            } catch (IOException e) {
                showErrorMessage(e);
            }
            updateGroupsList();
        ...
        addButton.addActionListener(actionEvent -> {
            ...
            try {
                ...
                op.performQuery(new Group(0, input));
            } catch (IOException e) {
                showErrorMessage(e);
            }
            updateGroupsList();
        ...
        studentUpdateButton.addActionListener(actionEvent -> {
            ...
            try {
                UpdateStudent op = new UpdateStudent(channel);
                op.performQuery(newStudent);
            } catch (IOException e) {
                showErrorMessage(e);
            }
            updateStudentsList();
        ...
        studentDeleteButton.addActionListener(actionEvent -> {
            ...
            try {
                DeleteStudent op = new DeleteStudent(channel);
                op.performQuery(selected.student.getId());
            } catch (IOException e) {
                showErrorMessage(e);
            }
            updateStudentsList();
        ...
        studentAddButton.addActionListener(actionEvent -> {
            ...
            try {
                AddStudent op = new AddStudent(channel);
                op.performQuery(new Student(
                        0,
    ...
    public void updateGroupsList() {
        ...
        try {
            GetAllGroups op = new GetAllGroups(channel);
            op.performQuery();
        } catch (IOException e) {
            showErrorMessage(e);
        }
    ...
    public void updateStudentsList() {
        ...
        if (selected == null) {
            ...
            try {
                GetStudentsFromGroup op = new GetStudentsFromGroup(channel);
                op.performQuery(selected.group.getId());
            } catch (IOException e) {
                showErrorMessage(e);
            }
    ...
    public void receiveStudentsList(ArrayList<Student> students) {
        studentsListModel.clear();
    ...
    public void receiveGroupsList(ArrayList<Group> groups) {
        ...
        for (Group group : groups) {
            groupsListModel.addElement(new GroupItem(group));
            studentGroupBoxModel.addElement(new GroupItem(group));
        }
    }
}
